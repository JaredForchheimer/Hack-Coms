"""OpenAI service for content validation and summarization via OpenRouter."""
...
class OpenAIService:
    """Service for interacting with OpenAI models via OpenRouter."""
    ...
    def __init__(self, api_key: str = None):
        ...
        # Use GPT-4 which is widely available on OpenRouter
        self.model = "openai/gpt-4o"
        self.timeout = current_app.config.get('LLM_REQUEST_TIMEOUT', 60)
        
        logger.info("Using OpenRouter API with OpenAI GPT-4")

    def validate_content(self, content: str, title: str = None) -> Dict[str, Any]:
        """Validate content for inappropriate material using GPT-4."""
        try:
            logger.info("Starting content validation with GPT-4")
            ...
            logger.error(f"Error validating content with GPT-4: {str(e)}")
            return {
                'success': False,
    ...
    def generate_summary(self, content: str, title: str = None) -> Dict[str, Any]:
        """Generate a summary of the content using GPT-4."""
        try:
            ...
            logger.error(f"Error generating summary with GPT-4: {str(e)}")
            return {
                'success': False,
...
"""
    ...
    def _parse_validation_response(self, response_text: str) -> Dict[str, Any]:
        """Parse GPT-4's validation response into structured data."""
        try:
    ...
    def test_connection(self) -> bool:
        """Test the OpenAI API connection via OpenRouter."""
        try:
            response = self.client.chat.completions.create(
                extra_headers={
                    "HTTP-Referer": "http://localhost:5000",
